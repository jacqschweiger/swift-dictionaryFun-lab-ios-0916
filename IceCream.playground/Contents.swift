...
countForIceCreamFlavor("Mexican Chocolate")
/*: directions5
...
func replaceFlavor(flavor: String, forPerson person: String) -> Bool {
    if flavor == favoriteFlavorsOfIceCream[person] || favoriteFlavorsOfIceCream.keys.contains(person) == false  {
        return false //return false for: flavor wasn't changed OR person isn't in the array
    } else {
...
replaceFlavor("Natural Vanilla", forPerson: "Tim")
